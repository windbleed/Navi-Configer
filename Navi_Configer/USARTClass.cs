...
namespace Navi_Configer
{
    class USARTClass
    {
       ...
       //public byte[] _data = new byte[100];

       public string ReceiveStr="None";
       ...
       static int ReadLength = 0;
        ...
        public USARTClass(string comPortName)

        {
            if (comPortName == null||comPortName=="") return;
        ...
        public USARTClass(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
...

       {
...

        {
...

            {
                    ...
                    ReadLength = _serialPort.BytesToRead;

                    _serialPort.Read(_data, 0, ReadLength);
                    ...
                    ReceiveStr = System.Text.Encoding.Default.GetString(_data);
                    IsReceived = true;
